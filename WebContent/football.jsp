...
<body id="top">
	<%
		...
		List<Sig_article> list3F = new ArrayList<Sig_article>();
		List<Sig_article> list3C = new ArrayList<Sig_article>();
		List<Sig_article> list3R = new ArrayList<Sig_article>();
		List<Sig_article> list3Cy = new ArrayList<Sig_article>();
		List<Sig_article> listSportMore = new ArrayList<Sig_article>();

		listSportMore = sig.getMoreSport();
		list = sig.getFootSport();
